...
![Figure 1. Area Map](img/rio-grande-basin.png){ width=80% }
...
- Updatable data sources are acquired at specified intervals – quarterly, or as needed. As new static data sources are
...
```
```{r graph,echo=FALSE}
plot(faithful, main="Do You Want Wait Longer?")
```
